...
class InterestsController extends BaseAdminController {
    ...
    public function edit(Interest $model)
        {
    ...
    public function update(Interest $model,FormRequest $request)
    {
        $data = $request->all();
