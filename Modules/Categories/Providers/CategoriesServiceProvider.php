...
class CategoriesServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $app->bind('Modules\Categories\Repositories\CategoryInterface', function (Application $app) {
            $repository = new EloquentCategory(new Category);
            return $repository;
        });

        /*$app->view->composer('categories::public.*', function ($view) {
            $view->page = \MyApp::getPageLinkedToModule('categories');
        });*/
    }
